...
export declare class TezosStorageHandler implements Handler {
    private readonly TEZOS_STORAGE_REGEX;
    getMetadata(contractAbstraction: ContractAbstraction<ContractProvider | Wallet>, { location }: Tzip16Uri, context: Context): Promise<string>;
    /**
