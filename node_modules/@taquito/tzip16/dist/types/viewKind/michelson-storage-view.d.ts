...
export declare class MichelsonStorageView implements View {
    ...
    constructor(viewName: string, contract: ContractAbstraction<ContractProvider | Wallet>, rpc: RpcClient, returnType: MichelsonV1Expression, code: MichelsonV1ExpressionExtended[], viewParameterType?: MichelsonV1ExpressionExtended | undefined);
    /**
